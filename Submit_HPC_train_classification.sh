...
python gennet/cli.py train -path /home/ahilten/repositories/pheno_red_hair/ -ID $1 -genotype_path /projects/0/emc17610/nvidia/UKBB_HRC_imputed/genotype/ -problem_type classification -lr $2 -bs $3 -L1 $4
